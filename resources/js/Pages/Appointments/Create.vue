          ...
          <div class="border border-gray-200 rounded-lg p-4">
            ...
            <div class="grid grid-cols-7 gap-1">
              <button v-for="(dayObj, idx) in calendarDays" :key="idx" @click="handleDateClick(dayObj.date)"
                :disabled="dayObj.isPast || !dayObj.isCurrentMonth || dayObj.isWeekend" :class="[
          ...
          <div class="border border-gray-200 rounded-lg p-4">
            ...
            <div v-else>
              ...
              <div v-else class="grid grid-cols-3 gap-2 max-h-64 overflow-y-auto">
                <button v-for="slot in slots" :key="slot.time" @click="pickSlot(slot)" :disabled="slot.taken" :class="[
